...
describe VisitorsHelper do
  describe '#display_countdown' do
    ...
    it 'should display countdown based on input' do
      ...
      event_instance.start_planned = DateTime.parse('2014-03-07 10:30:00 UTC')
      expect(helper.display_countdown(event_instance)).to eq '2 days 1 hour 15 minutes'
    end
    it 'should display countdown based on input and remove days when 0' do
      ...
      event_instance = FactoryGirl.create(:event_instance)
      event_instance.start_planned = DateTime.parse('2014-03-07 10:30:00 UTC')
      expect(helper.display_countdown(event_instance)).to eq '1 hour 15 minutes'
    end
  end
